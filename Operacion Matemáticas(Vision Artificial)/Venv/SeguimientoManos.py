...
class detectormanos():
    ...
    def encontrarmanos(self, frame, dibujar=True):
        ...
        if self.resultados.multi_hand_landmarks:
            for mano in self.resultados.multi_hand_landmarks:
                if dibujar:
                    self.dibujo.draw_landmarks(frame, mano, self.mpmanos.HAND_CONECTIONS)
        return frame
    ...
    def distancia(self, p1, p2, frame, dibujar=True, r=15, t=3):
        ...
        if dibujar:
            ...
            cv2.circle(frame, (x1, y1,), r, (0, 0, 225), cv2.FILLED)
            cv2.circle(frame, (x2, y2,), r, (0, 0, 225), cv2.FILLED)
            cv2.circle(frame, (cx, cy,), r, (0, 0, 225), cv2.FILLED)
